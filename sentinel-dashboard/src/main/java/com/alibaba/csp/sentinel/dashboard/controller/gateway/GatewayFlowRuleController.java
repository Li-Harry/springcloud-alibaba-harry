...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.GatewayFlowRuleNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.GatewayFlowRuleNacosPublisher;
...
public class GatewayFlowRuleController {
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
        ...
        try {
            ...
            if (nacosPropertiesConfiguration.isEnable()) {
                rules = gatewayFlowRuleNacosProvider.getRules(app);
            }
