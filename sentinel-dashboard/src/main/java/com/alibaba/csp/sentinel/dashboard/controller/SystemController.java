...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.SystemRuleNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.SystemRuleNacosPublisher;
    ...
    public Result<List<SystemRuleEntity>> apiQueryMachineRules(String app, String ip,
        ...
        try {
            ...
            if (nacosPropertiesConfiguration.isEnable()) {
                rules = systemRuleNacosProvider.getRules(app);
            }
